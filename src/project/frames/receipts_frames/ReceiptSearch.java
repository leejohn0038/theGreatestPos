...
public class ReceiptSearch extends JFrame {
	...
	public ReceiptSearch(Receipts r) {
		...
		add(f[0] = new TextField(170, 60, 150, 30));
		add(new Label("~", 330, 60, 30, 30));
		add(f[1] = new TextField(170, 90, 150, 30));
		
		add(new Label("전화번호", 50, 305, 100, 50));
		add(f[2] = new TextField(170, 310, 150, 30));
		
		add(new Label("가격", 50, 195, 100, 50));
		add(f[3] = new TextField(170, 200, 150, 30));
		add(new Label("~", 330, 200, 30, 30));
		add(f[4] = new TextField(170, 230, 150, 30));
		
		add(new Label("결제수단", 50, 265, 100, 50));
		add(f[5] = new TextField(170, 270, 150, 30));		

		add(new Label("구매시기", 50, 125, 100, 50));
		add(f[6] = new TextField(170, 130, 150, 30));
		add(new Label("~", 330, 130, 30, 30));
		add(f[7] = new TextField(170, 160, 150, 30));
